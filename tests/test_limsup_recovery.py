import numpy as np
from sim.gamma_convergence import test_field_and_grad, discrete_action, continuum_action_MC
...
def test_gamma_convergence_small():
    ...
    n,_=test_field_and_grad(X); Se=discrete_action(rows,cols,W,n); SMC=continuum_action_MC(X,V)
